...
public class GetAvailableSuggestion extends BaseAPI {

    String apiPath="/products/suggestions";
    String accessToken;
    String baseSiteId;
    String query_key;
    String query_value;

    public GetAvailableSuggestion(String baseURI,String baseSiteId,String query_key,String query_value,String accessToken) {
        super(baseURI);

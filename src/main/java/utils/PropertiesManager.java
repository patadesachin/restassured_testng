...
public class PropertiesManager {
     ...
     * @throws IOException
     */
    public static void initializeProperties(String country) throws IOException {
        properties = new Properties();
        FileInputStream iStr = new FileInputStream("src\\main\\resources\\"+country+".properties");
